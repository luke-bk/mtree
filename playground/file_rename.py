...
# import os
#
# # Assuming the .xlsx file path and the data path are provided
# xlsx_file_path = 'file.xlsx'  # Replace with your .xlsx file path
# folder_path = 'data'        # Replace with your data path
#
...
# # The script also assumes that the file names in the .xlsx file match exactly with those in the data. It starts reading from the second row, considering the first row as headers.

import os

# Replace this with the path to your data containing the files
folder_path = 'data'

# Iterate over the files in the data and rename them
...
# Note: This script will rename all files in the specified data to the format "image_0_X.dcm",
